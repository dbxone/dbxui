...
In DBXChain, each account is separated into
...
In DBXChain an *authority* consists of one or many entities that authorize an
...
must sign in order for the transaction to be valid. Now, in DBXChain, we have
