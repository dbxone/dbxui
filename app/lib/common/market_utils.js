...
const MarketUtils = {
    ...
    parseOrder(order, base, quote, invert = false) {
        ...
        if (order.debt) {
            if (invert) {
                // Price in USD/DBX, amount should be in DBX, value should be in USD, debt is in USD
                ...
                // Price in DBX/USD, amount should be in USD, value should be in BTS, debt is in USD
